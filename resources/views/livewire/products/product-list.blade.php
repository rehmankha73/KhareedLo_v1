    ...
    <div class="w-1/3 pb-4">
        ...
        <section class="mb-2 py-4 border-b border-gray-200">
            ...
            <div class="my-2 pr-3 flex flex-row">
                <input class="rounded w-2/3" type="text" placeholder="Search any product">
                <button class="w-1/3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Search</button>
            </div>
        </section>
