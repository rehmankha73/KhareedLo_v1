...
{{--                                </div>--}}
                        ...
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Product Variant</h3>
                                <p class="mt-1 text-sm text-gray-600">
                                    Use a permanent address where you can receive mail.
                                </p>
                            </div>
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-4 gap-6">
                                        <div class="col-span-2">
                                            <label for="colors"
                                                   class="block text-sm font-medium text-gray-700">Colors</label>
                                            <input wire:model.defer="colors" type="text" name="colors" id="colors"
                                                   placeholder="Product Colors, (Note:Colors should be comma separated)"
                                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('colors') border-red-600 @enderror">
                                            @error('colors')
                                            <span class="text-red-600">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-span-2">
                                            <label for="sizes"
                                                   class="block text-sm font-medium text-gray-700">Sizes</label>
                                            <input wire:model.defer="sizes" type="text" name="sizes" id="sizes"
                                                   placeholder="Product Sizes, (Note:Sizes should be comma separated)"
                                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('sizes') border-red-600 @enderror">
                                            @error('sizes')
                                            <span class="text-red-600">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-span-4">
                                            <label for="others"
                                                   class="block text-sm font-medium text-gray-700">Others</label>
                                            <input wire:model.defer="others" type="text" name="others" id="others"
                                                   placeholder="Product Others, (Note:Others should be comma separated)"
                                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('others') border-red-600 @enderror">
                                            @error('others')
                                            <span class="text-red-600">{{ $message }}</span>
                                            @enderror
                                        </div>
