<x-guest-layout>
    <header class="w-full bg-nordic-gray-light flex border border-red-500 pt-12 md:pt-0 md:items-center bg-cover bg-right"
            style="max-width:1600px; height: 300px; background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80');">
    ...
    <main class="font-sans text-gray-900 antialiased border border-red-500">
